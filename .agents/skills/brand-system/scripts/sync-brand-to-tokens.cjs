 ...
 *
 * Syncs Guidelines.md colors → design-tokens.json → design-tokens.css
 *
 * Usage:
...
// Paths
const BRAND_GUIDELINES = 'docs/Guidelines.md';
const DESIGN_TOKENS_JSON = 'assets/design-tokens.json';
const DESIGN_TOKENS_CSS = 'assets/design-tokens.css';
// NOTE: This script is optional. If missing, CSS regeneration is skipped gracefully.
const GENERATE_TOKENS_SCRIPT = '.agents/skills/design-tokens/scripts/generate-tokens.cjs';
