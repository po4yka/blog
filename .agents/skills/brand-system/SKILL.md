...
```bash
node .agents/skills/brand-system/scripts/inject-brand-context.cjs
node .agents/skills/brand-system/scripts/inject-brand-context.cjs --json
```

**Validate an asset:**
```bash
node .agents/skills/brand-system/scripts/validate-asset.cjs <asset-path>
```

**Extract/compare colors:**
```bash
node .agents/skills/brand-system/scripts/extract-colors.cjs --palette
node .agents/skills/brand-system/scripts/extract-colors.cjs <image-path>
```
...
node .agents/skills/brand-system/scripts/sync-brand-to-tokens.cjs
# 3. Verify
node .agents/skills/brand-system/scripts/inject-brand-context.cjs --json | head -20
```
