...
# search-slides.py is not installed. Use this reference doc directly instead.
# python .agents/skills/ui-ux-pro-max/scripts/search.py "investor pitch" --domain product

# Get emotion arc
# search-slides.py is not installed. Use this reference doc directly instead.
# python .agents/skills/ui-ux-pro-max/scripts/search.py "series a funding" --domain product --json
```
