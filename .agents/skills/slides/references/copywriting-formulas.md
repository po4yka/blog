...
# python .agents/skills/ui-ux-pro-max/scripts/search.py "problem agitation" --domain ux

# Get emotion-appropriate formula
# search-slides.py is not installed. Use this reference doc directly instead.
# python .agents/skills/ui-ux-pro-max/scripts/search.py "urgency cta" --domain ux
```
