...
# python .agents/skills/ui-ux-pro-max/scripts/search.py "metrics dashboard" --domain style

# Contextual recommendation
# search-slides.py is not installed. Use this reference doc directly instead.
# python .agents/skills/ui-ux-pro-max/scripts/search.py "traction slide" \
