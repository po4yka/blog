...
export const POST = withAdmin(
  { capability: "write:<entities>", schema: mySchema },
  async ({ db, data }) => {
...
2. Session auth from the HttpOnly cookie (`requireAuth`)
3. Capability check
...
- [ ] A route test in `src/__tests__/api/` covers success, 401/403, and 400 paths
