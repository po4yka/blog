...
2. **Pause and ask the user to choose a direction.** Use `request_user_input` when available, otherwise ask directly before writing any code. Explain trade-offs (browser support, performance cost, complexity).
