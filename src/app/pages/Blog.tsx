...
import { blogPosts, categories } from "../components/blogData";
import { BootBlock, Cmd, Accent, MacWindow } from "../components/Terminal";
import { useInView } from "../components/useInView";
import { CpuGraph } from "../components/Decorations";
    ...
    <div className="space-y-8">
      ...
      <BootBlock
        lines={[
          ...
          {
            status: "OK",
            text: `${blogPosts.length} published posts — more queued`,
          },
          {
            status: "INFO",
            text: featured ? (
              ...
              >
                {filtered.map((post, i) => (
                  <motion.button
                    ...
                    className="group w-full text-left flex items-start gap-3 py-3.5 border-b border-border/50 last:border-b-0 -mx-2 px-2 cursor-pointer"
