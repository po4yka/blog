...
export const projects: Project[] = [
  ...
  },
  {
    ...
    name: "Heimdall",
    slug: "heimdall",
    description: "Local-first analytics dashboard for AI-assisted engineering. Unified cost, burn-rate, cache efficiency, and waste-detection across 9 coding assistants.",
    ...
    platforms: ["Tooling", "macOS"],
    tags: ["Rust", "Swift", "TypeScript", "MCP", "SQLite", "FinOps", "Observability"],
    links: [{ type: "GitHub", href: "https://github.com/po4yka/heimdall" }],
    featured: true,
    previewLabel: "heimdall",
    year: "2026",
    status: "Active",
  },
  {
  ...
  },
  {
    ...
    name: "po4yka.dev",
    slug: "blog",
    description: "Personal portfolio and technical blog. Astro 7 + React 19 islands, Cloudflare Workers + D1, WebAuthn admin panel.",
    longDescription: "This site. Built with Astro 7 and React 19 islands architecture, deployed on Cloudflare Workers with D1 (SQLite) for the database. Admin panel uses passkey-first authentication via WebAuthn. Content pipeline is single-source: MDX for blog posts, JSON for projects and experience, with build-time generators producing static TypeScript data files and seed SQL. Designed with anti-AI-slop principles: minimal, credible aesthetic where typography carries the design.",
    platforms: ["Web"],
  ...
  },
  {
    ...
    name: "Ratatoskr",
    slug: "ratatoskr",
    description: "Self-hosted messenger between you and the internet. Pulls articles, videos, and feeds, summarizes with LLMs, delivers signal — not feed. KMP, web, and Telegram clients.",
